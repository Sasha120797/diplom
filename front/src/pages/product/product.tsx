                    ...
                    <div className="product-page-description">
                        <div className="product-page-photo">
                            <div className="product-page-photos-small">
                                <img src={"http://localhost:3000/static/" + loadedProduct.images[0]} alt="" className="product-page-photo-small" onClick={() => handleThumbnailClick(0)} />
                                <img src={"http://localhost:3000/static/" + loadedProduct.images[1]} alt="" className="product-page-photo-small" onClick={() => handleThumbnailClick(1)} />
                                <img src={"http://localhost:3000/static/" + loadedProduct.images[2]} alt="" className="product-page-photo-small" onClick={() => handleThumbnailClick(2)} />
                                <img src={"http://localhost:3000/static/" + loadedProduct.images[3]} alt="" className="product-page-photo-small" onClick={() => handleThumbnailClick(3)} />
                                <img src={"http://localhost:3000/static/" + loadedProduct.images[4]} alt="" className="product-page-photo-small" onClick={() => handleThumbnailClick(4)} />
                            </div>
                            <div className="product-page-current-photo">
                                <img src={"http://localhost:3000/static/" + loadedProduct.images[currentImageIndex]} alt="" style={{ transition: 'opacity 0.3s ease' }} />
                            </div>
                        </div>
                        <div className="product-page-info">
                            ...
                            <div className="product-page-info-buttons">
                                ...
                                <svg className="product-page-info-button-share" onClick={() => { copyToClipboard("http://localhost:3001/product/" + id) }} width="31" height="31" viewBox="0 0 31 31" fill="none"
